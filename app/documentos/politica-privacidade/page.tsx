...
export default function PrivacyPolicyPage() {
  ...
  const translations = {
    "pt-BR": {
      ...
      <p class="mb-4">A MeshMe nomeou um Encarregado de Proteção de Dados para supervisar a conformidade com esta Política de Privacidade e servir como ponto de contato para quaisquer perguntas ou solicitações relacionadas à privacidade e proteção de dados.</p>
  ...
  // Atualizar a URL quando o idioma muda
  useEffect(() => {
