...
export default function AppCompanies() {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 animate-fade-in-up">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">
            <span className="text-primary">times</span> que estão no app
          </h2>
          <p className="text-gray-600">Empresas que já transformaram sua cultura através da MeshMe</p>
        </div>
        ...
        <div className="w-full overflow-hidden">
          <div ref={scrollRef} className="flex gap-8 py-4 overflow-x-hidden">
            {duplicatedCompanies.map((company, index) => (
              <Card
                key={index}
                className={`flex-shrink-0 w-44 h-20 flex items-center justify-center p-4 border border-gray-100 transform hover:scale-105 transition-all duration-300 ${
