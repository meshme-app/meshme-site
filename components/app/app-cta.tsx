        ...
        <div className="text-center space-y-8 animate-fade-in-up">
          <div className="space-y-4">
            ...
            <p className="text-xl text-white/90 max-w-2xl mx-auto">
              Junte-se a centenas de empresas que já estão promovendo bem-estar e engajamento através do MeshMe
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Button size="lg" className="bg-white text-primary hover:bg-white/90 group min-w-[200px]" asChild>
            ...
            {/* Botão WhatsApp */}
            <Button size="lg" className="bg-secondary hover:bg-secondary/90 text-white min-w-[200px]" asChild>
              <a
