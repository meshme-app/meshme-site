          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10">
              <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900 leading-tight">
                ROI para <span className="text-[#FF7816]">empresas</span>
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="bg-white rounded-xl p-6 border border-gray-100">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-gray-900 text-base font-bold mb-1">Custo com saúde</h3>
                    <p className="text-sm text-gray-600 leading-relaxed mb-2">
                      Programas de wellness corporativo reduzem custos médicos em <span className="text-[#FF7816] font-bold">US$ 3,27 para cada US$ 1 investido</span>.
                    </p>
                    <a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC2873731/" target="_blank" rel="noopener noreferrer" className="text-xs text-gray-400 hover:text-[#FF7816] transition-colors inline-flex items-center gap-1">
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-100">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-gray-900 text-base font-bold mb-1">Absenteísmo</h3>
                    <p className="text-sm text-gray-600 leading-relaxed mb-2">
                      Unidades com alto engajamento têm <span className="text-[#FF7816] font-bold">81% menos absenteísmo</span>.
                    </p>
                    <a href="https://www.gallup.com/workplace/236927/employee-engagement-drives-growth.aspx" target="_blank" rel="noopener noreferrer" className="text-xs text-gray-400 hover:text-[#FF7816] transition-colors inline-flex items-center gap-1">
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-100">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-gray-900 text-base font-bold mb-1">Produtividade</h3>
                    <p className="text-sm text-gray-600 leading-relaxed mb-2">
                      Unidades com alto engajamento têm <span className="text-[#99F700] font-bold">18% mais produtividade</span> (sales).
                    </p>
                    <a href="https://www.gallup.com/workplace/236927/employee-engagement-drives-growth.aspx" target="_blank" rel="noopener noreferrer" className="text-xs text-gray-400 hover:text-[#99F700] transition-colors inline-flex items-center gap-1">
                      Gallup <ExternalLink className="h-3 w-3" />
                    </a>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-100">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-gray-900 text-base font-bold mb-1">Retenção</h3>
                    <p className="text-sm text-gray-600 leading-relaxed mb-2">
