...
const photos = [
  ...
  },
  {
    ...
    alt: "Partida do Corporate Games",
    sport: "Corporate Games",
  },
]
...
export default function CGPhotoGallery() {
  ...
  return (
    <section id="galeria" className="py-20 bg-white relative overflow-hidden">
      <div className="absolute inset-0 bg-black/5 skew-y-[-2deg] transform origin-top-right"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="relative h-full w-full group">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div className="absolute bottom-4 left-4 text-white">
                      <p className="font-semibold text-sm bg-[#B91C1C] px-2 py-1 rounded skew-x-[-5deg] transform">
        ...
        <div className="text-center mt-8">
          <p className="text-gray-600">
            ...
            <span className="text-[#B91C1C] font-semibold cursor-pointer hover:underline">Inscreva-se agora!</span>
          </p>
        </div>
      </div>
    </section>
