...
const testimonials = [
  ...
  {
    quote: "O esporte tem correlação total com o nosso dia a dia no trabalho: colaboração, disciplina e estratégia.",
    name: "Carlos Fan",
    role: "Managing Director",
    company: "Accenture",
    ...
    <section id="depoimentos" className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 mt-2">O que as empresas participantes dizem sobre o Corporate Games</p>
        </div>
          ...
          <div className="relative">
            <Card className="border-none shadow-lg transform hover:rotate-1 transition-transform duration-300">
              <CardContent className="p-8">
                <div className="absolute -top-6 left-8 w-12 h-12 rounded-full bg-[#B91C1C] flex items-center justify-center animate-pulse-scale">
                ...
                <div className="pt-6">
                  ...
                  <div className="relative inline-block mb-6 -ml-2">
                    ...
                    <div className="absolute inset-0 bg-black transform rotate-[1deg] skew-x-[-4deg] rounded-tl-2xl rounded-br-2xl opacity-80"></div>
                    ...
                    <div className="absolute -bottom-2 -right-2 w-6 h-6 bg-[#B91C1C] rounded-full opacity-60 animate-pulse-slow"></div>
                    <div className="absolute -top-2 -left-2 w-4 h-4 bg-black rounded-full opacity-60 animate-pulse-slow"></div>
                  </div>

                  <div className="flex items-center">
                    <Avatar className="h-16 w-16 mr-4 border-3 border-[#B91C1C] shadow-lg">
                      <AvatarImage
            ...
            <div className="flex justify-center mt-8 gap-4">
              <Button
                ...
                className="rounded-full border-gray-300 hover:bg-[#B91C1C]/10 hover:border-[#B91C1C] transform hover:scale-110 transition-transform"
              >
