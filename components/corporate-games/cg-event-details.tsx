    ...
    <section id="detalhes" className="py-20 bg-gray-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 mt-2">Tudo o que você precisa saber sobre o Corporate Games São Paulo</p>
        </div>
          ...
          <Card className="border-none shadow-md hover:shadow-lg transition-shadow transform hover:rotate-1 hover:scale-105 transition-all duration-300">
            <CardContent className="p-6">
              <div className="flex flex-col items-center text-center">
                <div className="w-14 h-14 rounded-full bg-[#B91C1C]/10 flex items-center justify-center mb-4">
                ...
                <Button variant="link" className="mt-4 text-[#B91C1C] hover:text-[#B91C1C]/80">
                  Ver no mapa
                </Button>
              </div>
            </CardContent>
            ...
            <CardContent className="p-6">
              <div className="flex flex-col items-center">
                ...
                <ul className="space-y-2 w-full">
                  {[
                    { event: "Corporate Games SP", dates: "Novembro 2026" },
                    { event: "Abertura", dates: "Sexta-feira" },
                    { event: "Competições", dates: "Sábado e Domingo" },
                    { event: "Encerramento", dates: "Domingo à noite" },
                  ].map((item, index) => (
                    <li
                      key={index}
                ...
                <div className="grid grid-cols-2 gap-x-4 gap-y-1 w-full">
                  {[
                    ...
                    <div key={index} className="flex items-center">
                      ...
                      <span className="text-gray-700 text-sm">{sport}</span>
                    </div>
                  ))}
                </div>
                <Button variant="link" className="mt-4 text-[#B91C1C] hover:text-[#B91C1C]/80">
