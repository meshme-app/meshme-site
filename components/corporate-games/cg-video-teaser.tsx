...
export default function CGVideoTeaser() {
  return (
    <section id="video" className="py-20 bg-gray-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 mt-2">Veja como é a energia do Corporate Games</p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative aspect-video rounded-xl overflow-hidden shadow-2xl transform hover:scale-105 transition-transform duration-300">
            <iframe
              ...
              title="Corporate Games 2026 - Teaser"
          ...
          <div className="text-center mt-8">
            <p className="text-gray-600 mb-4">
              Sinta a energia, a competição e a confraternização que só o Corporate Games proporciona!
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="bg-[#B91C1C] hover:bg-[#B91C1C]/90 text-white px-6 py-3 rounded-lg font-semibold transform hover:scale-105 transition-transform inline-block text-center"
              >
                Quero levar minha empresa
              </a>
              <button className="bg-black hover:bg-black/90 text-white px-6 py-3 rounded-lg font-semibold transform hover:scale-105 transition-transform">
